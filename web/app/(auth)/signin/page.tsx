...
export default function SignInPage() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-brand-mist px-6 font-sans">
      <div className="w-full max-w-md rounded-2xl bg-white shadow-md p-8 border border-brand/10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <div className="text-xs text-brand/60">Grant Engine</div>
          </div>
        </div>
        <h1 className="text-xl font-semibold text-brand-ink mb-2">Sign in</h1>
        <p className="text-sm text-brand/70 mb-6">
          Sign in with your Grant Engine Google account to access the
          application hub.
        </p>
        <button
          type="button"
